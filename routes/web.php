...
Route::get('/forgot-password', $controller_path . '\front_page\LandingController@forgot_password');
Route::get('/change-password', $controller_path . '\front_page\LandingController@change_password');
