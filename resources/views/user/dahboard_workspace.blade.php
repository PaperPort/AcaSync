...
@section('judul', 'Dashboard Workspace')
        ...
        <section class="flex justify-end pr-3 pt-5" aria-label="Breadcrumb" id="breadcumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center" aria-current="page">
                    <a href="{{'/id-workspace/dashboard'}}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue">
            ...
            <div class="grid lg:grid-cols-3 gap-5">
                <div class="px-5 py-8 w-full border bg-yellow border-gray-200 rounded-lg shadow hover:bg-orange">
                    <div class="flex flex-col">
                        ...
                        <div class="flex justify-end mt-4 md:mt-6">
                            <a href="{{'/id-workspace/id-kelasmapel/'}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white border-0 border-white rounded-lg hover:bg-white hover:text-yellow first-letter:focus:ring-4 focus:outline-none focus:ring-blue-300">Masuk</a>
                        </div>
                    </div>
                </div>
                <div class="px-5 py-8 w-full border bg-sky border-gray-200 rounded-lg shadow hover:bg-blue">
                    <div class="flex flex-col">
                        ...
                        <div class="flex justify-end mt-4 md:mt-6">
                            <a href="{{'/id-workspace/id-kelasmapel/'}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white border-0 border-white rounded-lg hover:bg-white hover:text-sky first-letter:focus:ring-4 focus:outline-none focus:ring-blue-300">Masuk</a>
                        </div>
                    </div>
                </div>
