            ...
            <div class="flex flex-col items-center justify-center lg:py-0">
                <div class="w-full rounded-lg">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <p class="font-light text-gray-400 text-center text-sm">Klik dibawah ini untuk dapat mereset ulang password.</p>
                        <a href="{{ url('/change-password/'.$verifyToken) }}" class="w-90 flex justify-center text-white bg-blue hover:bg-sky focus:ring-4 focus:outline-none focus:ring-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center">Masuk</a>
                    </div>
                </div>
            </div>
        </div>
